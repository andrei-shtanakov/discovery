...
- [ ] L3, четвёртая волна — caller: сверять требования между собой (засеянные несовместимости — *между* двумя требованиями, конфликты caller'а — *внутри* одного); затем S3 ×3 и третья выборка судьи @owner:github:andrei-shtanakov @blocked_by:todo://discovery/l3-third-wave @id:l3-fourth-wave @epic:eco.discovery-runtime

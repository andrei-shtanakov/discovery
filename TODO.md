...
- [ ] Повтор entry id между ответами: рантайм рендерит каждый экземпляр, линтер правила не имеет — решить, отказывать ли на `answer` или считать последнюю версию по id @owner:github:andrei-shtanakov @id:duplicate-entry-ids-across-answers @epic:eco.discovery-runtime
